...
public class DataManagerTest {
  ...
  public void testDMSingle() throws InterruptedException {
    MockTransactionManager tm0 = new MockTransactionManager();
  ...
  public void testDMMulti() throws InterruptedException {
    ...
    MockDataManager mdm = MockDataManager.newMockDataManager();
    ...
    new File("/tmp/TestDNMulti.log").delete();
  }

  @Test
  public void testRecoverySimple() throws InterruptedException {
    TransactionManagerImpl tm0 = TransactionManager.create("/tmp/TestRecoverySimple");
