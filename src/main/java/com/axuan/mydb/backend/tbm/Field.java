...
import com.axuan.mydb.backend.im.BPlusTree;
import com.axuan.mydb.backend.parser.statement.SingleExpression;
  ...
  public FieldCalRes calExp(SingleExpression exp) {
    ...
    switch (exp.compareOp) {
      case "<":
        ...
        if (res.right > 0) {
          res.right--; // 范围从0～right--,因为下标从0开始的
        }
        break;
      case "=":
        v = string2Value(exp.value);
